...
class Schedule extends Model
{
    ...
    {
        // dd($this->start_time->diff(Carbon::now())->invert == 0);
        return $this->start_time > Carbon::now();
        // return $this->start_time->diff(Carbon::now())->invert == 0;
    }

    public function isEnd()
    {
        return $this->end_time < Carbon::now();
        // return Carbon::now()->diff($this->end_time)->invert == 0;
    }
